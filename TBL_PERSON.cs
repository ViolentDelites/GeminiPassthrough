...
public partial class TBL_PERSON
{
    ...
    public virtual LK_HEAR_ABOUT_US? HEAR_ABOUT_US { get; set; }

    [ForeignKey("REGISTRATION_TYPE_ID")]
    [InverseProperty("TBL_PERSON")]
    public virtual LK_REGISTRATION_TYPE? REGISTRATION_TYPE { get; set; }

    [ForeignKey("SUFFIX_ID")]
    [InverseProperty("TBL_PERSON")]
    public virtual LK_SUFFIX? SUFFIX { get; set; }

    [InverseProperty("PERSON")]
    public virtual ICollection<TBL_ADDRESS> TBL_ADDRESS { get; set; } = new List<TBL_ADDRESS>();

    [InverseProperty("PERSON")]
    public virtual ICollection<TBL_NOTIFICATION_TRACKING> TBL_NOTIFICATION_TRACKING { get; set; } = new List<TBL_NOTIFICATION_TRACKING>();

    [ForeignKey("address_note_id")]
    [InverseProperty("TBL_PERSON")]
    public virtual LK_ADDRESS_NOTE address_note { get; set; } = null!;
}
